Generate and install the app icon for /tmp/nexen-audit-edge.
...
/tmp/nexen-audit-edge/app/src/main/res/drawable/icon.png
...
After saving icon.png, validate it with `bash /home/codex-agent/codex-app-agent/validate-icon.sh /tmp/nexen-audit-edge/app/src/main/res/drawable/icon.png`.
