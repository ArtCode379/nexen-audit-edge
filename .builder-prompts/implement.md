...
Project directory: /tmp/nexen-audit-edge

Task metadata:
- Asana task gid: 1217484336586849
- Asana task name: GB GW4 C1539
- Asana URL: https://app.asana.com/1/1208304498069546/project/1213586227413017/task/1217484336586849
- App name: Nexen Audit Edge
- Company: NEXEN STRATEGY LIMITED
- Domain: https://nexenstrategy.study
- Package: nexenstrategy.technology.nexenauditedge
- Prefix: LMAQN
- Type: service
...
2. Do not create project-local agent instruction files inside /tmp/nexen-audit-edge.
