...
private val onboardingPagesContent = listOf<OnboardingContent>(
    OnboardingContent(
        titleRes = R.string.lmaqn_page_1_title,
        descriptionRes = R.string.lmaqn_page_1_description,
        imageRes = R.drawable.lmaqn_ic_launcher_background,
    ),
    OnboardingContent(
        titleRes = R.string.lmaqn_page_2_title,
        descriptionRes = R.string.lmaqn_page_2_description,
        imageRes = R.drawable.lmaqn_ic_launcher_background,
    ),
    OnboardingContent(
        titleRes = R.string.lmaqn_page_2_title,
...
fun OnboardingScreen(
    ...
    viewModel: LMAQNOnboardingVM = koinViewModel(),
